...
const NotificationsPage = () => {
  ...
  // ✅ Debug logs
  console.log("📥 Full friendRequests API response:", friendRequests);
              ...
              <section className="space-y-4">
                ...
                <div className="space-y-3">
                  {incomingRequests.map((request) => {
                    ...
                    const senderPic =
                      sender?.profilePic || "/fallback-avatar.png";
              ...
              <section className="space-y-4">
                ...
                <div className="space-y-3">
                  {acceptedRequests.map((notification) => {
                    ...
                    const recipientPic =
                      recipient?.profilePic || "/fallback-avatar.png";
